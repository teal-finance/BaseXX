...
// Encode encodes binary bytes into a Base92 string
// using the default alphabet.
func Encode(bin []byte) string {
	return EncodeAlphabet(bin, StdAlphabet)
}

// EncodeAlphabet encodes binary bytes into a Base92 string
...
// Decode decodes a Base92 string into binary bytes
// using the default alphabet.
func Decode(str string) ([]byte, error) {
	return DecodeAlphabet(str, StdAlphabet)
}

// DecodeAlphabet decodes a Base92 string into binary bytes
// using the given alphabet.
